<template>
    <nav class="bg-white border-end user-select-none">
        <div class="p-3 sticky-top">
            <div
                class="d-flex align-items-center justify-content-center text-center mb-3 mb-md-0 me-md-auto text-decoration-none"
            >
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <template v-for="(link, key) in sidebar" :key="key">
                    <li
                        v-if="
                            !link.admin_only || $attrs.auth.user.can.manage_user
                        "
                    >
                        <inertia-link
                            class="nav-link"
